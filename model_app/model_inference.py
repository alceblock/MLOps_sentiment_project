...
# from model_app.model_utility import MODEL_PATH, LATEST_MODEL_PATH
...
# # this function is used to save the default model if no other version already exists.
# from contextlib import asynccontextmanager
# from model_app.model_utility import save_default_model
# import os
# @asynccontextmanager
# async def lifespan(_: FastAPI):
#     if not ( os.path.exists(LATEST_MODEL_PATH) and os.path.exists(MODEL_PATH) ):
...
#     # AI Annotator label
#     user_label = data.label if data.label else "not_specified"
#     print(f"No label has been provided: {user_label}")
